...
function _gnbMove($_depth1,$_depth2,$_depth3) {
	if($_depth1 == 1) {
		...
		return;
	} else if($_depth1 == 3) { // 클래스관리
		if($_depth2==1) {
			location.href="../classmanagement/클래스승인관리_리스트.html";
		} else if($_depth2==2) {
			return;
		} else if($_depth2==3) {
			return;
	...
	} else if($_depth1 == 4) { // 공방관리
		if($_depth2==1) {
			location.href="../workshop/공방관리_리스트.html";
		} else if($_depth2==2) {
			return;
		}
	} else if($_depth1 == 5) { // 게시글관리
		if($_depth2==1) {
			location.href="../board/함께하기_리스트.html";
		} else if($_depth2==2) {
			location.href="../board/후기관리_리스트.html";
		} else if($_depth2==3) {
			location.href="../board/공지이벤트관리_리스트.html";
		}	
	} else if($_depth1 == 6) { // 추천관리
		if($_depth2==1) {
			location.href="../recommand/배너관리_리스트.html";
		} else if($_depth2==2) {
			location.href="../recommand/추천클래스관리_리스트.html";
		}		
	} else if($_depth1 == 7) { // 관리
		if($_depth2==1) {
			return;
		} else if($_depth2==2) {
			if($_depth3==1) {
